...
function Footer() {
  return (
    <>
      <footer id='footer' className='bg-[#181531]'>
        <div id="top-footer" className='flex sm:flex-row flex-col  space-y-10 sm:space-y-0  py-14'>
          ...
          <div className='w-60 space-y-6 mx-auto px-2'>
        ...
        <div id="bottom-footer" className='bg-black flex flex-col items-center text-center  sm:flex-row  justify-between py-4'>
