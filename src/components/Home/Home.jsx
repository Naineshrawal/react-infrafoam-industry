...
function Home() {
  ...
  return (
    <>
      <section id="hero" className='section-container bg-hero-bg mt-4 sm:bg-contain  bg-bottom sm:bg-center bg-no-repeat  w-full min-h-[90vh]'>
      ...
      <section id="product-sales" className='my-20 bg-sales-bg bg-cover bg-no-repeat bg-center bg-fixed'>
      ...
      <section id="our-products" className=''>
          ...
          <div id="mattresses" className='w-full my-10 bg-our-product-bg bg-cover bg-no-repeat bg-center bg-fixed '>
            <div className='bg-black/35'>
      ...
      <section id='trust' className='mt-16 bg-[#181531] bg-trust-bg bg-cover bg-no-repeat bg-center'>
