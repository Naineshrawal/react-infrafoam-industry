  ...
  return (
    <div className='w-[full]  md:w-[50%] mx-1 bg-[#f5f5f5]'>
      ...
      <div className='w-full overflow-hidden bg-red-400 relative '>
          <Link to={`blogpage/${id}`}><img className=' w-[100%] h-[300px] object-cover hover:scale-110 duration-500'  width='520px' height="auto"  src={cover} alt="blog-1 img" /></Link>
      ...
      <div className='relative -top-12 p-7 mx-3 mb-6 bg-[#f5f5f5]'>
        <Link to={`/blogpage/${id}`}><h1 className='text-lg font-bold text-[#0b0051] duration-500 hover:text-[#343692]'>{title}<span>	&#10230;</span></h1></Link>
